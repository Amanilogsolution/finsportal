...
try {
    ...
    const result = await sql.query(`INSERT into FINSDB.dbo.tbl_cust_addresses(cust_id ,billing_address_attention,billing_address_country,billing_address_city,billing_address_state,billing_address_pincode,    
...
const InsertVendorAddress = async (req, res) => {
   ...
   const SelectCustAddress = async (req, res) => {
    ...
    try{
        await sql.connect(sqlConfig)
        const result = await sql.query(`SELECT  cust_name FROM FINSDB.dbo.tbl_cust_addresses WHERE cust_name LIKE '%${cust_name}%';`)
    ...
    const TotalCustAddress = async (req, res) => {
        ...
        try{
            await sql.connect(sqlConfig)
            const result = await sql.query(`SELECT * FROM FINSDB.dbo.tbl_cust_addresses WHERE cust_name ='${cust_id}';`)
            res.send(result.recordset)
        }
        catch(err){
            console.log(err)
    ...
    const DeleteCustAddress = async (req, res) => {
        ...
        try{
            await sql.connect(sqlConfig)
            const result = await sql.query(`update FINSDB.dbo.tbl_cust_addresses set status='${status}' where sno='${sno}'`)
            res.send('Deleted')
        }
        catch(err){
            console.log(err)
     ...
     const CustAddress = async (req, res) => {
            ...
            try{await sql.connect(sqlConfig)
                const result = await sql.query(`SELECT * from FINSDB.dbo.tbl_cust_addresses where sno='${sno}'`)
