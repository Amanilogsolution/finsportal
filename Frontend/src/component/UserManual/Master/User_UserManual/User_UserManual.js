            ...
            <div className='p-4'>
                <div className='d-flex justify-content-around'>
                    <div className='m-auto' style={{ width: "70%" }}>
                        <h2>User</h2>
                        <p>The first step is go onto sidebar click onto Master dropdown. You will see options select User</p>
                    </div>
                ...
                <div className=''>
                    <h2>Total user</h2>
                    <p>After click on user you will see the interface total User table</p>
                ...
                <div className='d-flex justify-content-between my-2'>
                    <div >
                        <h2>Update User</h2>
                        <p>If you want to update user we also have option click on the UserId at Total User table,</p>
                        <p>Fill mandatory Fields and than click on update button to update the User Data</p>
                    </div>
                    <div>
...
export default User_UserManual;