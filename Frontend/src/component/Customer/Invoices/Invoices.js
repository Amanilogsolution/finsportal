...
function Invoices() {
    ...
    const handleChangeActivity = async (e, index) => {
        e.preventDefault();
        console.log(e.target.value, ' nsdjbc', index)
