                                        ...
                                        <form autoComplete="off">
                                            <div className="form-row mt-2">
                                                ...
                                                <div className="d-flex col-md">
                                                    <select id="cust_id" className="form-control col-md-5" disabled>
                                            ...
                                            <div className="form-row mt-2">
                                                ...
                                                <div className="d-flex col-md">
                                                    <button type="button" className="btn border col-md-5" data-toggle="modal" data-target="#custAddnmodal" disabled
                                                        onClick={(e) => {
                                                            e.preventDefault();
                                                            setTimeout(() => {
                                            ...
                                            <div className='d-flex justify-content-between'>
                                                <div style={{ width: "40%" }}>
                                                    <div className="form mt-2">
                                                        ...
                                                        <div className="d-flex col-md">
                                                            <textarea type="text" className="form-control " rows="2" id="remark" disabled defaultValue={soData.remark}></textarea>
                                                        </div>
