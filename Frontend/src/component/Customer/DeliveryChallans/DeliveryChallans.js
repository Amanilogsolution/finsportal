                            ...
                            <div className="col">
                                <div className="card">
                                    <article
                                        className="card-body"
                                    >
                                        <h3 className="text-left"> New Delivery Challan</h3>
                                        <br />
                                        ...
                                        <form autoComplete="off">
                                            ...
                                            <div className="form-row mt-3">
                                                <label className="col-md-2 col-form-label font-weight-normal" >Delivery Challan#<span style={{ color: "red" }}>*</span> </label>
                                                <div className="d-flex col-md">
                                                    <input type="text" className="form-control col-md-5" id="Accountname" placeholder="DC-00001" />
                                            ...
                                            <div className="form-row mt-3">
                                                <label className="col-md-2 col-form-label font-weight-normal" >Delivery Challan Date<span style={{ color: "red" }}>*</span> </label>
                                                <div className="d-flex col-md">
                                            ...
                                            <div className="form-row mt-2">
                                                <label className="col-md-2 col-form-label font-weight-normal" >Challan Type </label>
                                                <div className="d-flex col-md-4">
