                            ...
                            <div className="col">
                                <div className="card">
                                    <article
                                        className="card-body"
                                    >
                                        <h3 className="text-left"> New Recurring Invoice</h3>
                                        <br />
                                        ...
                                        <form autoComplete="off">
                                            ...
                                            <div className="form-row mt-3">
                                                <label className="col-md-2 col-form-label font-weight-normal" >Profile Name<span style={{ color: "red" }}>*</span> </label>
                                            ...
                                            <div className="form-row mt-3">
                                                <label className="col-md-2 col-form-label font-weight-normal" >Repeat Every<span style={{ color: "red" }}>*</span></label>
                                                <div className="d-flex col-md-4">
                                                <select
                                                        id="AccountType"
                                                        className="form-control"
                                            ...
                                            <div className="form-row mt-3">
                                                <label className="col-md-2 col-form-label font-weight-normal" >Start On </label>
                                                <div className="d-flex col-md-3">
                                                    <input type="date" className="form-control col-md-6" id="Accountname"  />
                                                </div>

                                                <label className="col-md-1 col-form-label font-weight-normal" >Ends On</label>
                                            ...
                                            <div className="form-row mt-2">
                                                <label className="col-md-2 col-form-label font-weight-normal" >Associate Project Hours </label>
                                                <div className="d-flex col-md-4">
                                                  <p>There are no active projects for this customer</p>
                                                </div>
                                            </div>
