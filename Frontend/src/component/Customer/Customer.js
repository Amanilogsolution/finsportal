...
const Customer = () => {
  ...
  const [custMastIdCount, setCustMastIdCount] = useState({
    masterId_count: 0,
    custId_count: 0
  })
  useEffect(() => {
    const fetchdata = async () => {
      ...
      custMastIdCount.masterId_count = mastid;
      mastid = '' + mastid
      ...
      custMastIdCount.custId_count = custidno;
      let custid = '' + custidno
                  ...
                  <form>
                    <div className="form-row">
                      <div className="col form-group" id="valexisting" >
                        ...
                        <label className="form-check form-check-inline">
                          ...
                          <span className="form-check-label font-weight-normal"> Non Existing </span>
                        </label>
                        <label className="form-check form-check-inline">
                          <input className="form-check-input" type="radio" name="masterid"
                            onClick={() => { setShowMaster(false); }}
                          />
                          <span className="form-check-label font-weight-normal"> Existing Customer </span>
                        </label>
                      </div>
                    </div>
                    ...
                    {showMaster ? (
                      ...
                      <div className="form-row" id='masterdropdown'>
                        <label htmlFor="user_name" className="col-md-2 col-form-label font-weight-normal">Master Id </label>
                        <div className="col form-group">
                          <select id="selectedmasterid" className="form-control col-md-4" >
                    ...
                    <div className="form-row">
                      <label htmlFor="cust_id" className="col-md-2 col-form-label font-weight-normal" > Customer Id</label>
                      <div className="col form-group">
                        <input type="text" id="cust_id" className="form-control col-md-4 cursor-notallow" value={generatedcust} disabled />
                      </div>
                    </div>
                    ...
                    <div className="form-row" onChange={handleChange}>
                      <div className="col form-group">
                        ...
                        <label className="form-check form-check-inline">
                          <input className="form-check-input" type="radio" name="Type" value="Individual" />
                          <span className="form-check-label font-weight-normal">
                            Individual
                          </span>
                        </label>
                    ...
                    <div className="form-row">
                      ...
                      <div className=" form-group">
                        <select id="inputSalute" className="form-control col-md-">
                    ...
                    <div className="form-row">
                      <label htmlFor="user_name" className="col-md-2 col-form-label font-weight-normal">
                        <div className="tooltip1" style={{ border: "none" }}>
                          <span className="text-danger" style={{ borderBottom: "1px dashed red" }}> Customer Display Name * </span>
                    ...
                    <div className="Other_Details mt-3" id="otherdtldiv" >
                      <div className="form-row">
                        <label htmlFor="gsttreatment" className="col-md-2 col-form-label font-weight-normal text-danger" >GST Treatment * </label>
                        <div className="col form-group">
                          <select id="gsttreatment" className="form-control col-md-4" onClick={selectgst} >
                            <option value='' hidden>Select GST Treatment</option>
                      ...
                      <div className="form-row" id="gstin" style={{ display: "none" }}>
                        <label htmlFor="gstin_uin" className="col-md-2 col-form-label font-weight-normal text-danger">GSTIN / UIN* </label>
                        <div className="col form-group">
                      ...
                      <div className="form-row">
                        <label htmlFor="place_of_supply" className="col-md-2 col-form-label font-weight-normal text-danger" > Place Of Supply * </label>
                        <div className="col form-group">
                      ...
                      <div className="form-row" onChange={handleChangetextPreferance}>
                        <div className="col form-group">
                          <label htmlFor="user_name" className="col-md-2 col-form-label font-weight-normal text-danger" >Tax Preference * </label>
                          <label className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" name="taxpreference" value="Taxable"
                              onClick={() => document.getElementById('exemptionreasonbox').style.display = "none"}
                            />
                            <span className="form-check-label font-weight-normal">Taxable </span>
                          </label>
                          <label className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" name="taxpreference" value="Tax Exempt"
                      ...
                      <div className="form-row " id="exemptionreasonbox" style={{ display: "none" }}>
                        <label htmlFor="exemption_reason" className="col-md-2 col-form-label font-weight-normal text-danger"> Exemption Reason *</label>
                        <div className=" form-group col" >
                          <input id="exemption_reason" className="form-control col-md-4" type="text" />
                        </div>
                      </div>
                      {/*---------------------------------- toogle exemption reason end -----------------------------------*/}

                      <div className="form-row" >
                        <label htmlFor="selectedcurrency" className="col-md-2 col-form-label font-weight-normal text-danger" >Currency *</label>
                        <div className="col-md-4 form-group pr-0">
                          <select id="selectedcurrency" className="form-control col-md-10 " data-live-search="true" >
                      ...
                      <div className="form-row">
                        ...
                        <div className="col form-group">
                          <input type="email" className="form-control col-md-4" id="opening_balance" />
                        </div>
                      </div>
                      ...
                      <div className="form-row">
                        ...
                        <div className="form-check" onClick={handleClickportal}>
                          <input className="form-check-input" type="checkbox" value="" id="click" />
                      ...
                      <div className="form-row">
                        <label htmlFor="inputState" className="col-md-2 col-form-label font-weight-normal"  >
                          <div className="tooltip1"> Portal Language
                            <span className="tooltipcontent">
                      ...
                      <div className="form-row">
                        ...
                        <div className="col form-group input-group">
                          <input className="form-control col-md-4" placeholder="www.twitter.com" type="url" id="twitter_url" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="Address mt-3" id="addressdiv" style={{ display: "none" }}>
                      <div className="Address_left" style={{ width: "70%" }}>
                        ...
                        <div className="form-row">
                          <label htmlFor="inputState" className="col-md-2 col-form-label font-weight-normal" >  State </label>
                          <div className="col-md-6 form-group">
                        ...
                        <div className="form-row">
                          ...
                          <div className="col form-group">
                            <input type="number" className="form-control col-md-7" id="billing_address_pincode" value={billpincount}
                              onChange={(e) => {
                        ...
                        <div className="form-row">
                          ...
                          <div className="col form-group">
                            <input type="number" className="form-control col-md-7" id="billing_address_phone" value={billphonecount}
                              onChange={(e) => {
                                if (e.target.value.length === 11) return false;
                    ...
                    <div className="form-column" id="remarkdiv" style={{ display: "none" }}>
                      ...
                      <div className="col form-group">
                        <textarea name="text" className="col-md-9" id="remark" cols="30" rows="5" ></textarea>
                      </div>
                    </div>
                    ...
                    <div className="Address mt-3" id="contactdiv" style={{ display: "none" }}>
                      ...
                      <div className="form-row">
                        <label htmlFor="contact_person_name" className="col-md-2 col-form-label font-weight-normal" >   First Name </label>
                        <div className="col form-group">
                          <input type="text" className="form-control col-md-4" id="contact_person_name" />
                        </div>
                      </div>
                      ...
                      <div className="form-row">
                        ...
                        <div className="col form-group">
                          <input type="number" className="form-control col-md-4" id="contact_person_work_phone" value={contworkphonecount}
                            onChange={(e) => {
                              if (e.target.value.length === 11) return false;
                      ...
                      <div className="form-row">
                        ...
                        <div className="col form-group">
                          <input type="number" className="form-control col-md-4" id="contact_person_phone" value={contphonecount}
                            onChange={(e) => {
                              if (e.target.value.length === 11) return false;
