...
import { getCNData, GetSubInvoice, InsertCnSub, SelectCnSubDetails, locationAddress, GetInvoice, Getfincialyearid, ChangeCNStatus, UpdateInvoiceCNFlag, showOrganisation } from '../../../api/index'
        ...
        <div>
            ...
            </div>
            {
                ChargeCodeSub.length > 0 ?
                    <CreditNotePreview ChargeCodeSub={ChargeCodeSub} data={cnData} location={location} custname={custname} orgdata={orgdata} />
                    : null
            }
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <p>
                            {`${data.length>0 ? (!data.total_cn_amt) ? '0' : document.getElementById('totalCnAmt').innerHTML : null}
                            is less than 
                            ${data && data.total_cn_amt} 
                            Are you Still want to make a Request`}
                            </p>
                        </div>
