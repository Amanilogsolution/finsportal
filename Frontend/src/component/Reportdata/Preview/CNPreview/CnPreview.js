...
import {getCNData} from '../../../../api'

const CnPreview = ({ cnNum }) => {
    ...
    useEffect(() => {
        const fetchdata = async () => {
            ...
            setOrgdata(result)
            const cn_result = await getCNData(org, cnNum)
            setData(cn_result)
            console.log(cn_result)
            // const Subdata = await SelectCnSubDetails(org, cnNum, result.inv_no, result1.length)
                                ...
                                <div className="div_for_border">
                                    ...
                                    <div className="credit_Note">
                                        ...
                                        <table id="cn_first_table" >
                                            <tbody>
                                                <tr>
                                                    <td><strong>Document No: </strong>{cnNum}</td>
