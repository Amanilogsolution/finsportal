                        ...
                        */}
                        ...
                        <div className="Other_Details mt-3" id="otherdetaildiv">
                          <div className="form-row">
                            ...
                            <div className="col form-group">
                              <input id="gsttreatment" className="form-control col-md-4" type='text' value={data.gst_treatment} disabled />
                          ...
                          <div className="form-row">
                            ...
                            <div className="col form-group">
                              <input type='text' id="source_of_supply"
                                className="form-control col-md-4"
                                disabled value={data.source_of_supply} />
                          ...
                          <div className="form-row">
                            ...
                            <div className="col form-group">
                              <input type='text' id="payment_terms"
                                className="form-control col-md-4"
                                disabled value={data.payment_terms} />
                            </div>
                          </div>
                          <div className="form-row">
                            <label
