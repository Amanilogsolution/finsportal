...
import { ActiveVendor, ActivePurchesItems, Activeunit, Getfincialyearid, InsertBill, ActiveUser, ActiveLocationAddress, InsertPurchaseorder, InsertSubPurchaseorder, Updatefinancialcount } from '../../../api'
...
function PurchaseOrder() {
    ...
    const handleSubmit = async (btntype) => {
        ...
        const flagsave = btntype;

        console.log(org, vendorname, polocation, ponumber, podate, userid, flagsave, poamount)
        return
